...
class _grafik_kebutuhanState extends State<grafik_kebutuhan> {
  ...
  Future getdataCabai() async {
    ...
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/cabai_acehBesar.php"));
    list = fromJson(response.body);
    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/cabai_bandaAceh.php"));
    list1 = fromJson(response1.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/cabai_lhok.php"));
  ...
  Future getdataBawang() async {
    ...
    List<Kebutuhan> list2 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/bawang_acehBesar.php"));
    if (response.statusCode == 200) {
      list = fromJson(response.body);
    }
    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/bawang_bandaAceh.php"));
    if (response1.statusCode == 200) {
      list1 = fromJson(response1.body);
    }
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/bawang_lhok.php"));
  ...
  Future getdataPadi() async {
    ...
    List<Kebutuhan> list2 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/beras_acehBesar.php"));
    ...
    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/beras_bandaAceh.php"));
    if (response1.statusCode == 200) {
      list1 = fromJson(response1.body);
    }
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_kebutuhan/beras_lhok.php"));
    if (response2.statusCode == 200) {
      list2 = fromJson(response2.body);
    }
