...
class _grafik_keseluruhan_bnaState extends State<grafik_keseluruhan_bna> {
  ...
  Future getdataCabai() async {
    ...
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/cabai.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/stock_cabai.php"));
  ...
  Future getdataBawang() async {
    ...
    List<Keseluruhan> list1 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/bawang.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/stock_bawang.php"));
    if (response2.statusCode == 200) {
      list1 = fromJson(response2.body);
    }
    hasilBawang = list;
  ...
  Future getdataPadi() async {
    ...
    List<Keseluruhan> list1 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/beras.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/banda_aceh/stock_beras.php"));
    if (response2.statusCode == 200) {
      list1 = fromJson(response2.body);
    }
    hasilPadi = list;
