...
class grafik_keseluruhan_lhok extends StatefulWidget {
  const grafik_keseluruhan_lhok({super.key});

  @override
  State<grafik_keseluruhan_lhok> createState() =>
      _grafik_keseluruhan_lhokState();
}

class _grafik_keseluruhan_lhokState extends State<grafik_keseluruhan_lhok> {
  ...
  Future getdataCabai() async {
    ...
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/cabai.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/stock_cabai.php"));
  ...
  Future getdataBawang() async {
    ...
    List<Keseluruhan> list1 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/bawang.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/stock_bawang.php"));
    if (response2.statusCode == 200) {
      list1 = fromJson(response2.body);
    }
    hasilBawang = list;
  ...
  Future getdataPadi() async {
    ...
    List<Keseluruhan> list1 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/beras.php"));
    list = fromJson(response.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_keseluruhan/lhok/stock_beras.php"));
    if (response2.statusCode == 200) {
      list1 = fromJson(response2.body);
    }
    hasilPadi = list;
