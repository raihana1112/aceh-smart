...
class _grafik_stockState extends State<grafik_stock> {
  ...
  Future getdataCabai() async {
    ...
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/cabai_acehBesar.php"));
    list = fromJson(response.body);
    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/cabai_bandaAceh.php"));
    list1 = fromJson(response1.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/cabai_lhok.php"));
  ...
  Future getdataBawang() async {
    ...
    List<Stock> list2 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/bawang_acehBesar.php"));
    list = fromJson(response.body);
    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/bawang_bandaAceh.php"));
    list1 = fromJson(response1.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/bawang_lhok.php"));
    list2 = fromJson(response2.body);
  ...
  Future getdataPadi() async {
    ...
    List<Stock> list2 = [];
    final response = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/beras_acehBesar.php"));
    list = fromJson(response.body);

    final response1 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/beras_bandaAceh.php"));
    list1 = fromJson(response1.body);
    final response2 = await http.get(Uri.parse(
        "http://192.168.100.198/login_app/grafik_stock/beras_lhok.php"));
    list2 = fromJson(response2.body);
